  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-4">
        <h2 className="text-lg font-semibold text-t-primary">Watchlist</h2>
        ...
        <>
            ...
            <table className="w-full">
              ...
              <tbody>
                {sorted.map((item) => {
                  ...
                  return (
                    <tr key={item.id} className="border-b border-b-subtle hover:bg-surface transition-colors">
                      ...
                      <td className="px-4 py-3 text-right text-sm text-t-faint">
          ...
          <div className="md:hidden">
            {sorted.map((item) => {
              ...
              const config = ASSET_TYPE_CONFIG[item.assetType ?? 'stock'];
              return (
                <div key={item.id} className="bg-surface-card border border-b-default rounded-xl p-4 mb-3">
